  ...
  return (
    <div
      ...
      style={{
        ...
        ...(borderRadius !== undefined && borderRadius !== '' ? { borderRadius: typeof borderRadius === 'number' ? `${borderRadius}px` : borderRadius } : {}),
        '--color-1': colors[0] || '#c084fc',
        '--color-2': colors[1] || '#f472b6',
        '--color-3': colors[2] || '#38bdf8',
        ...glowVars,
